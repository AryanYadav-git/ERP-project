...
const UserProfile = () => {
  ...
  const {user, setUser, setDepartment, setIsClicked, initialState, name, department} = useStateContext();
    ...
    <div className="nav-item absolute right-1 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      ...
      <div className="flex gap-5 items-center mt-6 border-color border-b-1 pb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm font-semibold dark:text-gray-400"> {user} </p>
        </div>
      </div>
      {/* <div>
