...
import {IroningForm} from '../components';
...
const Ironing = () => {
  const myDepartment = ['finishing','admin'];
    ...
    const retrieveOrders = async () => {
        const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/finishing/ironing/get`,{
            headers: {
  ...
  return (
    <div>
      <Toaster />
      {isDepartment && <IroningForm />}
      <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
        <Header category="Finishing Department" title="Daily Ironing Reports" />
